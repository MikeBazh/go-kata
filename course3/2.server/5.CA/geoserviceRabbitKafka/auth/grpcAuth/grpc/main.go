...
import (
	...
	pb "go-kata/2.server/5.CA/GeoAuthUserProxy/auth/grpcAuth/grpc/example"
...
//		if !ok {
//			return &pb.TokenResponse{Valid: false, ErrorMessage: "Token does not contain login information"}, nil
//		}
//		return &pb.TokenResponse{Valid: true, Login: login}, nil
//	} else {
//		return &pb.TokenResponse{Valid: false, ErrorMessage: "Invalid token"}, nil
//	}
//}
