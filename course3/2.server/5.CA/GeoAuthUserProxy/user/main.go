...
import (
	...
	"go-kata/2.server/5.CA/GeoAuthUserProxy/user/controller"
	"go-kata/2.server/5.CA/GeoAuthUserProxy/user/responder"
	"go-kata/2.server/5.CA/GeoAuthUserProxy/user/services"
	"log"
	"net/http"
	"os"
	"os/signal"
