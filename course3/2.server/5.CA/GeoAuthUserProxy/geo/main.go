...
import (
	...
	"go-kata/2.server/5.CA/GeoAuthUserProxy/geo/controller"
	"go-kata/2.server/5.CA/GeoAuthUserProxy/geo/responder"
	"go-kata/2.server/5.CA/GeoAuthUserProxy/geo/services"
	"go-kata/2.server/5.CA/GeoAuthUserProxy/geo/storage"
	"log"
	"net/http"
	"os"
	"os/signal"
