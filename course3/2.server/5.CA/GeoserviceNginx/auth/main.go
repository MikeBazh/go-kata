...
import (
	...
	"go-kata/2.server/5.CA/GeoserviceNginx/auth/controller"
	"go-kata/2.server/5.CA/GeoserviceNginx/auth/responder"
	"go-kata/2.server/5.CA/GeoserviceNginx/auth/services"
	"log"
	"net/http"
	"os"
	"os/signal"
